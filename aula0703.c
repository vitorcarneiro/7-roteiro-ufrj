...
Descricao: Programa de testes para funcoes MostrarMonitor, GerarDistribuicaoInicial e LimparMonitor
...
{
	unsigned numeroMaximoLinhas, numeroMaximoColunas, indice;
...
/* TRATAMENTO DE ERROS ---------------------------------------------------------------------------- */
	...
	{
		printf ("Uso: %s <inteiro-nao-negativo> <inteiro-nao-negativo> <inteiro-nao-negativo>\n", argv[0]);
