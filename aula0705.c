...
#define NUMERO_ARGUMENTOS_ESTATICOS		    7
#define EOS						            '\0'

int
main (int argc, char *argv[])
{
	unsigned numeroMaximoLinhas, numeroMaximoColunas, indice, numeroVertices, numeroPontos;
...
/* TRATAMENTO DE ERROS ---------------------------------------------------------------------------- */
	...
	numeroVertices =  strtoul(argv[6], &verificacao, 10);
	if (*verificacao != EOS)
	{
		printf ("Argumento 6 <numero-vertices> contem caractere invalido. \n");
